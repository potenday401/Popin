...
fileprivate final class UIColorPDSPreviewViewController: UIViewController, UICollectionViewDataSource {
    ...
    private let colors: [Color] = [
        ...
        Color(name: "gray700", value: UIColor.gray700),
        Color(name: "lightGray100", value: UIColor.lightGray100),
        Color(name: "lightGray200", value: UIColor.lightGray200),
        Color(name: "lightGray300", value: UIColor.lightGray300),
        Color(name: "lightGray400", value: UIColor.lightGray400),
        Color(name: "lightGray500", value: UIColor.lightGray500),
        Color(name: "lightGray600", value: UIColor.lightGray600),
        Color(name: "darkGray100", value: UIColor.darkGray100),
        Color(name: "darkGray200", value: UIColor.darkGray200),
        Color(name: "darkGray300", value: UIColor.darkGray300),
        Color(name: "darkGray400", value: UIColor.darkGray400),
        Color(name: "darkGray500", value: UIColor.darkGray500),
        Color(name: "darkGray600", value: UIColor.darkGray600),
